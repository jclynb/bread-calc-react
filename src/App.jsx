    ...
    return (
      <div className="App"> 
        ...
        <ul>
          ...
          <br></br>
          <li> <strong> Salt choice:</strong> The default set for salt percentage for lean doughs is 2%. You can add a little over or a little under, but don't stray too far from the 2% mark or you'll end up hurting the yeast activity/rise of your bread (yeasts hate salt!) </li>
          <br></br>
          <li><strong>Hydration for eggs and butter:</strong> This app uses generic averages to calculate the % hydration for these two ingredients. The weight of your egg will also vary, and this app uses 50g for the weight of a standard egg. The real % in your dough may vary depending on what brand of butter and size of egg used.</li>
          <br></br>
